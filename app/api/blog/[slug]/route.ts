...
// Same complete blog posts as main route - in production this would come from a database
const mockPosts = [
  {
    id: '1',
...
Beyond the cameras and lenses, these accessories complete my concert photography kit. A lens cleaning kit is always in my bag because a dirty lens can ruin a great shot (you'd be amazed how many photographers I see around with dirty lenses).

This setup is packed into my reliable Pelican 1510 case for transport, with everything organized in the Peak Design Camera Cube for quick access during shoots. The custom 3D-printed battery holder keeps my six Canon batteries organized and protected—no more fumbling around looking for a charged battery in the dark.

The Leatherman has saved me countless times for quick equipment adjustments, and the compact LED light is perfect for checking camera settings in dark venues or providing subtle fill light when needed.
...
<img src="https://images.unsplash.com/photo-1518481612222-68bbe828ecd1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2000&q=80" alt="Camera Battery Grip" style="width: 100%; max-width: 600px; height: auto; margin: 20px 0; border-radius: 8px;">
